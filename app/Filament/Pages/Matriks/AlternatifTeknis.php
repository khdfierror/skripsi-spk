...
use App\Models\Matriks\AlternatifTeknis as AlternatifTeknisModel;
use Filament\Notifications\Notification;
use Filament\Pages\Page;
use Illuminate\Support\Collection;

class AlternatifTeknis extends Page
{
    protected static ?string $navigationIcon = null;
    protected static ?string $title = 'Matriks Alternatif Terhadap Teknis';
    protected static ?string $navigationGroup = 'Matriks';
    protected static ?int $navigationSort = 3;
    protected static ?string $navigationLabel = 'Teknis';
    protected static string $view = 'filament.pages.matriks.alternatif-teknis';
    ...
    {
        $values = AlternatifTeknisModel::all();
    ...
    public function save()
    {
        foreach ($this->inputValues as $kiriId => $row) {
            foreach ($row as $atasId => $nilai) {
                AlternatifTeknisModel::updateOrCreate(
                    [
