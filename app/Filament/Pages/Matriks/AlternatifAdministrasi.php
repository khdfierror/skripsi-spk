...
use App\Models\Matriks\AlternatifAdministrasi as AlternatifAdministrasiModel;
use Filament\Notifications\Notification;
use Filament\Pages\Page;
use Illuminate\Support\Collection;

class AlternatifAdministrasi extends Page
{
    protected static ?string $navigationIcon = null;
    protected static ?string $title = 'Matriks Alternatif Terhadap Administrasi';
    protected static ?string $navigationGroup = 'Matriks';
    protected static ?int $navigationSort = 1;
    protected static ?string $navigationLabel = 'Administrasi';
    protected static string $view = 'filament.pages.matriks.alternatif-administrasi';
    ...
    {
        $values = AlternatifAdministrasiModel::all();
    ...
    public function save()
    {
        ...
        Notification::make()
            ->title('Data Perhitungan Alternatif Administrasi berhasil disimpan!')
            ->success()
            ->send();
