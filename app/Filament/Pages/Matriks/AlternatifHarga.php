...
use App\Models\Matriks\AlternatifHarga as AlternatifHargaModel;
use Filament\Notifications\Notification;
use Filament\Pages\Page;
use Illuminate\Support\Collection;

class AlternatifHarga extends Page
{
    protected static ?string $navigationIcon = null;
    protected static ?string $title = 'Matriks Alternatif Terhadap Harga';
    protected static ?string $navigationGroup = 'Matriks';
    protected static ?int $navigationSort = 4;
    protected static ?string $navigationLabel = 'Harga';
    protected static string $view = 'filament.pages.matriks.alternatif-harga';
    ...
    {
        $values = AlternatifHargaModel::all();
    ...
    public function save()
    {
        foreach ($this->inputValues as $kiriId => $row) {
            foreach ($row as $atasId => $nilai) {
                AlternatifHargaModel::updateOrCreate(
                    [
